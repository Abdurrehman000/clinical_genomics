...
process CALL_VARIANTS {
	publishDir "results/variant_calls", mode: 'copy'
    ...
    run_clair3.sh --bam_fn=$bam_file --ref_fn=$ref_genome --output=. --threads=${task.cpus} --platform="ont" --model_path="/opt/models/r941_prom_hac_g360+g422"
    """
}
